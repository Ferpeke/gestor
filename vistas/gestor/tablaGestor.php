  ...
  <div class="row">
    <div class="col-sm-12">
      <div class="table-resposive">
        <table class="table table-hover table-striped table-dark" id="tablaGestorDataTable" style="text-align: center;">
          <thead>
            <tr>
              <th>Categoria</th>
              <th>Nombre</th>
          ...
          <tbody style="text-align: center;">
            <?php
              ...
              */
              ...
              $extencionesValidas = array('png', 'jpg', 'txt', 'pdf', 'mp3', 'mp4', 'sql', 'zip', 'rar', 'docx', 'pptx' );
